        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-600 md:text-base">
              Every annual function is a celebration of talent, confidence, and
              teamwork. From inspiring performances to unforgettable moments on
              stage, students express their creativity while building
              leadership, communication, and lifelong memories that define their
              school journey.
            </p>
          </div>
