...
const galleryImages: GalleryImage[] = [
  { src: "/views/Expert-Teachers/img1.jpg", alt: "Expert Teachers 1" },
  { src: "/views/Expert-Teachers/img2.jpg", alt: "Expert Teachers 2" },
  { src: "/views/Expert-Teachers/img3.jpg", alt: "Expert Teachers 3" },
  { src: "/views/Expert-Teachers/img4.jpg", alt: "Expert Teachers 4" },
  { src: "/views/Expert-Teachers/img5.jpg", alt: "Expert Teachers 5" },
  { src: "/views/Expert-Teachers/img6.jpg", alt: "Expert Teachers 6" },
  { src: "/views/Expert-Teachers/img7.jpg", alt: "Expert Teachers 7" },
  { src: "/views/Expert-Teachers/img8.jpg", alt: "Expert Teachers 8" },
  { src: "/views/Expert-Teachers/img9.jpg", alt: "Expert Teachers 9" },
];
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-600 md:text-base">
              Our experienced educators inspire learning with passion,
              innovation, and personal attention. They mentor every student to
              build knowledge, confidence, strong values, and the skills needed
