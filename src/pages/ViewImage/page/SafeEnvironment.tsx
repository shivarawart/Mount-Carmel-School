...
const galleryImages: GalleryImage[] = [
  { src: "/views/safeEnvironment/img1.jpg", alt: "Safe Environment 1" },
  { src: "/views/safeEnvironment/img2.jpg", alt: "Safe Environment 2" },
  { src: "/views/safeEnvironment/img3.jpg", alt: "Safe Environment 3" },
  { src: "/views/safeEnvironment/img4.jpg", alt: "Safe Environment 4" },
  { src: "/views/safeEnvironment/img5.jpg", alt: "Safe Environment 5" },
  { src: "/views/safeEnvironment/img6.jpg", alt: "Safe Environment 6" },
  { src: "/views/safeEnvironment/img7.jpg", alt: "Safe Environment 7" },
  { src: "/views/safeEnvironment/img8.jpg", alt: "Safe Environment 8" },
  { src: "/views/safeEnvironment/img9.jpg", alt: "Safe Environment 9" },
  { src: "/views/safeEnvironment/img10.jpg", alt: "Safe Environment 10" },
  { src: "/views/safeEnvironment/img11.jpg", alt: "Safe Environment 11" },
  { src: "/views/safeEnvironment/img12.jpg", alt: "Safe Environment 12" },
  { src: "/views/safeEnvironment/img13.jpg", alt: "Safe Environment 13" },
  { src: "/views/safeEnvironment/img14.jpg", alt: "Safe Environment 14" },
  { src: "/views/safeEnvironment/img15.jpg", alt: "Safe Environment 15" },
  { src: "/views/safeEnvironment/img16.jpg", alt: "Safe Environment 16" },
  { src: "/views/safeEnvironment/img17.jpg", alt: "Safe Environment 17" },
  { src: "/views/safeEnvironment/img18.jpg", alt: "Safe Environment 18" },
  { src: "/views/safeEnvironment/img19.jpg", alt: "Safe Environment 19" },
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-600 md:text-base">
              A secure, caring, and inclusive campus creates the perfect
              foundation for learning. With modern safety measures and a culture
              of respect, every student feels valued, protected, and empowered
